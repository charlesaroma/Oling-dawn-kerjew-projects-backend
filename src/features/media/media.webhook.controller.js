...
function verifySignature(rawBody, signature) {
  if (!env.IMAGEKIT_WEBHOOK_SECRET || !signature) return false;
...
// Keeps the Media table in sync with ImageKit-side events that don't go
// through our own /record endpoint — e.g. a file uploaded or deleted
// directly from ImageKit's dashboard rather than through this app.
